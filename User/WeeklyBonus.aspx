<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="WeeklyBonus.aspx.cs" Inherits="User_WBI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="nav-justified">
        ...
        <tr>
            <td colspan="2">
                <center><h2>Weekly Bonus Income</h2></center></td>
        </tr>
        <tr>
            <td>
                &nbsp;</td>
