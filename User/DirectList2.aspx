<%@ Page Title="" Language="C#" MasterPageFile="~/user/MasterPage.master" AutoEventWireup="true" CodeFile="DirectList2.aspx.cs" Inherits="newuser_Direct2" %>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    EmptyDataText="YOU HAVE NO DIRECT SPONSER " ForeColor="#333333">
