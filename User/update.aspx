<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="User_update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="border: 2px solid #FF0000; padding-left: 50px;" >
        ...
        <tr>
            <td colspan="4"><center>
                <asp:Label ID="Label44" runat="server" Font-Bold="True" Font-Size="Large" Text="Enter User Id"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="TextBox24" runat="server" AutoPostBack="true" OnTextChanged="TextBox24_TextChanged"></asp:TextBox>
            </center></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 309px">
                <asp:TextBox ID="txtname" runat="server" placeholder="Enter UserName" 
        ...
        <tr>
            ...
            <td style="width: 309px">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtmob" ErrorMessage="*"></asp:RequiredFieldValidator>
            </td>
            <td style="width: 177px">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
