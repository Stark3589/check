...
public partial class User_Directlist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                DataTable dt = ob.dttt("select c.dateofjoin,c.rtime,c.username,c.name,a.sponser,c.mobile,c.status from sponser a, register c where c.username=a.username and c.status='Active' ");
