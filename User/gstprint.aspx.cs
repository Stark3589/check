...
public partial class User_gstprint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string sql = "select a.username,a.name,a.address,a.dateofjoin,a.invoice_no from register a where a.dateofjoin between '" + date + "' and '" + dateee + "' order by dateofjoin asc";
