<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="clubgeneology.aspx.cs" Inherits="nUser_geneologyclub" %>
...
<table  style=" overflow: scroll; clip: rect(5px, 5px, 5px, 5px); border-spacing: 5px; background-color: #C5F1C6; border-radius:15px; width:200px; height:150px">
    ...
    <tr><td>Left :</td><td><asp:Label ID="t74" runat="server" Text="XXXX"></asp:Label></td></tr>
     ...
     <cc1:hovermenuextender ID="HoverMenuExtender15" runat="server" TargetControlID="ImageButton9" PopupControlID="Panel15" PopupPosition="left">
        </cc1:hovermenuextender>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<table  style=" overflow: scroll; clip: rect(5px, 5px, 5px, 5px); border-spacing: 5px; background-color: #C5F1C6; border-radius:15px; width:200px; height:150px">
    ...
    <tr><td>Left :</td><td><asp:Label ID="t154" runat="server" Text="XXXX"></asp:Label></td></tr>
     ...
     <cc1:hovermenuextender ID="HoverMenuExtender13" runat="server" TargetControlID="ImageButton19" PopupControlID="Panel13" PopupPosition="top">
        </cc1:hovermenuextender>
                <br />
                <br />
                <span class="fa arrow">
