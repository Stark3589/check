<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="Reg.aspx.cs" Inherits="User_Reg" %>
...
ValidationExpression="[0-9]{10}" ForeColor="Red"></asp:RegularExpressionValidator>  
                 ...
                 <div class="input_field">
						<label for="login"><i class="icon-phone"></i>PAN No</label>
						   <asp:TextBox ID="panno" CssClass="form-control" runat="server"></asp:TextBox>
                       </div></div>
