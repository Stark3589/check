...
public partial class User_WDPI : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            DataTable dt = ob.dttt("select purchase,date,username from DailyRecord where date!='" + System.DateTime.UtcNow.ToString("yyyy-MM-dd") + "' and username='" + TextBox1.Text + "' and date>'" + date + "'");
