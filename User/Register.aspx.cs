...
public partial class registeration1 : System.Web.UI.Page
{
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
      ...
      string strcon = "Data Source=A2NWPLSK14SQL-v02.shr.prod.iad2.secureserver.net;Initial Catalog= zxeautopool;Persist Security Info=True;User Id= zxeautopool;Password=Zxeautopool@kt@776;";
            if (TextBox2.Text != "" && txtsponser.Text!="" )
            {
                ...
                {
                    //da.Close();
                    //SqlDataReader dr = ob.drrr("select * from pinmanage where pin='" + txt_pin.Text + "' and reguser is null");
                    //if (dr.Read())
                    //{
                        ob.CloseConn();
                        ...
                        try
                        {
                           ...
                           // ob.Execute("update pinmanage set reguser='" + TextBox2.Text + "',dates='" + date + "' where pin='" + txt_pin.Text + "' ");
                            ...
                            Response.Redirect("http://zxesmartworld.com/ShowDetail.aspx?username=" + TextBox2.Text + "&password=" + TextBox21.Text + "&Name=" + TextBox3.Text);
                            //Response.Write("<script>alert('Id Successfully Registered')</script>");
                ...
                //    else
                //    {
                //        Response.Write("<script>alert('Wrong pin')</script>");
                //        txt_pin.Text = "";
                //    }
    ...
    protected void txtsponser_TextChanged(object sender, EventArgs e)
    {
        try {
            ...
            { lbsponser.Text = "Wrong sponser id"; }
        }
        catch (Exception ex)
        { }
    }
