<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="WeeklyDsi.aspx.cs" Inherits="User_WDSI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table class="nav-justified">
        ...
        <tr>
            <td colspan="2">
                <center><h2>Weekly Direct Sponser Income</h2></center></td>
        </tr>
        <tr>
            <td>
                &nbsp;</td>
