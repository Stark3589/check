...
public partial class User_WDSI : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            DataTable dt = ob.dttt("select sponser,date,username from DailyRecord where date!='" + System.DateTime.UtcNow.ToString("yyyy-MM-dd") + "' and username='" + TextBox1.Text + "' and date>'" + date + "'");
