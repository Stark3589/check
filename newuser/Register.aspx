<%@ Page Title="" Language="C#" MasterPageFile="~/newuser/masterfrn.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="registeration1" ValidateRequest="false" %>
...
<asp:TextBox ID="TextBox22" runat="server" Visible="False"></asp:TextBox>
    ...
    <div class="row">
               ...
               <div class="col-md-4">
                <div class="form-group row last">
                    <label class="col-md-4">Sponser Id</label>
                    <div class="col-md-8">
       ...
       <div class="col-md-4">
                <div class="form-group row last">
                    ...
                    <div class="col-md-8">
 <asp:TextBox ID="TextBox8" runat="server" CssClass="form-control" MaxLength="10"  required></asp:TextBox>
                        <asp:RegularExpressionValidator ID="revMobNo" runat="server" ErrorMessage="Invalid Mobile Number."
    ValidationExpression="^([0-9]{10})$" ControlToValidate="TextBox8" ValidationGroup="Validate"
    ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
           ...
           <asp:TextBox ID="TextBox21" Visible="false" runat="server" CssClass="form-control" ></asp:TextBox>
            <asp:TextBox ID="txt_pin"  runat="server"  CssClass="form-control" placeholder="Enter Txn Password" Visible="false"
                                required=""></asp:TextBox>
