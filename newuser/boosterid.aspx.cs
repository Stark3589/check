...
public partial class newuser_boosterid : System.Web.UI.Page
{
                ...
                if (Convert.ToDouble(TextBox2.Text) <= Convert.ToDouble(TextBox1.Text))
                {
                    ...
                    if (dr.Read())
                    {
                        ...
                        try
                        {
                            ...
                            string sql111 = "insert into fundaccount(username,credit,debit,date,status,U_id)values('" + Session["newuser"].ToString() + "','0','" + TextBox2.Text + "','" + ob.utc().ToString("yyyy-MM-dd") + "','Invested On','" + txtunameid.Text + "')";
                            ob.Execute(sql111);
                    ...
                    {
                        ob.CloseConn();
                        Response.Write("<script>alert('Active first the try boost id')</script>");
                    }
