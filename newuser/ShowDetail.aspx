            ...
            <br /><br /><br /><br />
			 <form id="form1" runat="server">
				...
				<h3 style="color:blue;"> <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></h3>
                   ...
                   <div class="input-group">
                    <h3 style="margin-left:20px;">Txn. Password : &nbsp;</h3>
				<h3 style="color:blue;"> <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></h3>
					<span class="bar"></span>
				</div>
        		<br>
				...
				<div class="input-group">
					<button>
						<span><a href="register.aspx" style="font-size:23px;"> Signup &nbsp;</a></span><i class="fas fa-sign-in-alt" ></i>
					</button>
                    <button>
						<span ><a href="homefrn.aspx" style="font-size:23px;"> Home &nbsp;</a> </span><i class="fas fa-sign-out-alt" ></i>
					</button>
				</div>
			</form>
