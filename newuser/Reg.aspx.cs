        ...
        try
        {
            if (CheckBox1.Checked)
            {
                ...
                else
                {
                    ...
                    if (Drpsopnser.Text.Length > 5 && lbsponsername.Text != "You Entered Wrong Sponser ID")
                    {
        ...
        try
        {
         ...
         //   int nomage = DateTime.Now.AddYears(-Convert.ToDateTime(nage.Text).Year).Year;
          //  int age = DateTime.Now.AddYears(-Convert.ToDateTime(uage.Text).Year).Year;
            //insert record
            string passwprd = EncodePasswordToBase64(password.Text);
            string txnpasswprd = EncodePasswordToBase64(txn.Text);
           // TextBox2.Text = DropDownList2.SelectedItem.Text + "-" + TextBox2.Text;
            ...
            sql1 += "values('" + txtupline.Text + "', '" + txtupline.Text + "','','" + txtuname.Text + "','" + txtuid.Text + "', '" + passwprd + "', '" + outsite + "', '" + datenow + "', '" + txtmobile.Text + "','Not Active','" + tme + "','" + doj + "','','','','','','','','','','','','" + panno.Text + "','','" + txnpasswprd + "')";
